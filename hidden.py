...
def main(hparams):
    ...
    train_embed, train_mapping = embed_dataset(
        model, model.train_dataloader.dataset, f"{hparams.model_type}-{hparams.task_name}-train.nn",
        f"{hparams.model_type}-{hparams.task_name}-train.json")

    val_embed, val_mapping = embed_dataset(
        model, model.val_dataloader.dataset, f"{hparams.model_type}-{hparams.task_name}-val.nn",
