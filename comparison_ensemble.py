...
predictions_df = (pd.DataFrame.from_dict(model_to_predictions)[subset] - 0.5) * 2  # Project to predictions to [-1, 1]
confidences_df = pd.DataFrame.from_dict(model_to_confidences)[subset]
