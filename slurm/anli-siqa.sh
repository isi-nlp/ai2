...
#SBATCH --job-name=ANLI_SIQA        # The name of this job. If removed the job will have name of your shell script.
...
echo ""
echo "Training anli + siqa data and evaluate on anli dev set"
python train.py task=alphanli-socialiqa-combined
echo ""
