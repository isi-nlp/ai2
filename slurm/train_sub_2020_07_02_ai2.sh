...
#SBATCH --array=0-2   # Submitting an array of (n-m+1) jobs, with $SLURM_ARRAY_TASK_ID ranging from n to m.
...
allParams=(
  'task=cycic_real_10 accumulate_grad_batches=16 batch_size=1 learning_rate=1e-5 random_seed=1813174159'
  'task=cycic_real_20 accumulate_grad_batches=16 batch_size=1 learning_rate=1e-5 random_seed=1813174159'
  'task=cycic_real accumulate_grad_batches=16 batch_size=1 learning_rate=5e-6 random_seed=1813174159'
)
params=${allParams[${SLURM_ARRAY_TASK_ID}]}
echo
