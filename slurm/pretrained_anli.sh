...
echo ""
python ai2/train.py "parameters/train-pretrained-roberta-large-${task}.params" -p build_on_pretrained_model outputs/roberta-large-baselines/alphanli-s42.ckpt
echo ""
