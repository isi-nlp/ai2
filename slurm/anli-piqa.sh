...
#SBATCH --job-name=ANLI_PIQA        # The name of this job. If removed the job will have name of your shell script.
...
echo ""
echo "Training anli + piqa data and evaluate on anli dev set"
python train.py task=alphanli-physicaliqa-combined
echo ""
