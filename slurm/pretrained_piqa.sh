...
#SBATCH --job-name=PIQA_BASED        # The name of this job. If removed the job will have name of your shell script.
...
allTask=(alphanli hellaswag socialiqa)
task=${allTask[${SLURM_ARRAY_TASK_ID}]}
echo ""
python ai2/train.py "parameters/train-pretrained-roberta-large-${task}.params" -p build_on_pretrained_model outputs/roberta-large-baselines/physicaliqa-s42.ckpt
echo ""
