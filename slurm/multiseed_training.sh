...
#SBATCH --job-name=MULTISEED_TRAINING   # The name of this job. If removed the job will have name of your shell script.
...
# Create a total array of models and seeds and permute them
